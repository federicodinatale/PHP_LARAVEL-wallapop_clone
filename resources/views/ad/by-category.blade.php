    ...
    <div class="row">
        <div class="col-8 flex-grow-1">
            <form class="d-flex " role="search">
                ...
                <input class="form-control me-2 search-navbar-cat w-100" type="search" placeholder="Buscar en Todas las categorias" aria-label="Search">
              </form>
        
        </div>
        <div class="col-4">
            <a href="" class="btn btn-search-cat">Prufondizar Busqueda</a>
        </div>
    </div>
